        ...
        <div className="bPiWai">
          ...
          {/* <div className="hZZvVz fiveCol">
            ...
            <ul className="lfPKDg">
              ...
              <li>
                <a href="/docs/store-allergen-guide.pdf">
                  Store dietary information
                </a>
              </li>
              <li>
                <a href="/docs/branded-nutritional-info.pdf">
                  Branded products dietary information
                </a>
              </li>
              <li>
                <a href="/docs/express-allergen-guide.pdf">
                  Express dietary information
                </a>
              </li>
              <li>
                <a href="/docs/ready-to-drink.pdf">
                  Ready to drink dietary information
                </a>
              </li>
              <li>
                <a
                  href="/docs/costa-at-home-nutritional-info.pdf"
                 
                >
                  Our coffee at home dietary information
                </a>
              </li>
              <li>
                <a
                  href="/docs/podio-countertop-nutritional-info.pdf"
                 
                >
                  Podio countertop dietary information
                </a>
              </li>
            </ul>
          </div> */}
          {/* <div className="hZZvVz fiveCol">
            <h6 className="cJMtyj">Gifting</h6>
            <ul className="lfPKDg">
              <li>
                <a
                  href="https://gifting.costa.co.uk/?utm_source=costauksite&amp;utm_medium=referral&amp;utm_campaign=giftcardsfooter"
              ...
              <li>
                <a
                  href="https://www.costacoffeeforbusiness.co.uk/"
          ...
          <div className="hZZvVz fiveCol">
            ...
            <ul className="lfPKDg">
              ...
              <li>
                <a href="https://www.costacareers.co.uk/">
                  Careers
                </a>
              </li> 
              */}
        ...
        <div className="gdDGuL">
          ...
          <div className="kUbxns">
            <ul className="QhwVB">
              <li>
                ...
                >
                  <svg
                    ...
                    height="30"
                    fill="currentColor"
                    className="bi bi-facebook bpcqgY"
                    viewBox="0 0 16 16"
                  >
              ...
              <li>
                <a href="https://twitter.com/CarlstonR22238" className="euKWLl">
                  <svg
                    width="30"
                    height="30"
                    fill="currentColor"
                    className="bi bi-twitter-x bpcqgY"
                    viewBox="0 0 16 16"
                  >
              ...
              <li>
                ...
                >
                  <svg
                    ...
                    height="30"
                    fill="currentColor"
                    className="bi bi-instagram bpcqgY"
                    viewBox="0 0 16 16"
                  >
              ...
              <li>
                <a
                  href="https://www.tiktok.com/@notslracoleber"
                  className="euKWLl"
                >
                  <svg
                    width="30"
              ...
              <li>
                <a
                  href="https://www.youtube.com/@notslrac325"
                  className="euKWLl"
                >
                  <svg
                    width="30"
                    height="30"
                    fill="currentColor"
                    className="bi bi-youtube bpcqgY"
                    viewBox="0 0 16 16"
                  >
